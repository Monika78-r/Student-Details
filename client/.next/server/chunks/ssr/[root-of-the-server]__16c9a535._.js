...
function Page() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingId) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/users/${editingId}`, form);
                setEditingId(null);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/users", form);
            }
            setForm({
                name: "",
                email: "",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16c9a535._.js.map